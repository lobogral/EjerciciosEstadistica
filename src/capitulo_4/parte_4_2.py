...
Var_X = redondear(E_disc.Var(x), 0)
...
f = E_disc.dist_a_dp(dist, x)
E_disc.establecer_dp(f)
Var_X = redondear(E_disc.Var_Alter(x), 2)
...
f = E_disc.dist_a_dp(dist, x)
E_disc.establecer_dp(f)
Var_g_X = redondear(E_disc.desv((2*x+1)**2), 1)
...
f = E_disc.dist_a_dp(dist, x)
E_disc.establecer_dp(f)
Var_X = redondear(E_disc.Var(x), 4)
desv_X = redondear(E_disc.desv(x), 4)
escribir("Var(X) =", Var_X)
