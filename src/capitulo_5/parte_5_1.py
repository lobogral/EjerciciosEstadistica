...
print("5.1")
uniforme.est_vals_dist(10, (x >= 1) & (x <= 10))
...
print("")
print("5.5")
binomial.est_vals_dist(x, 0.3, 20)
...
print("")
print("5.7")
binomial.est_vals_dist(x, 0.7, 10)
print("a) P(X < 5) =", redondear(binomial.prob(x < 5), 4))
binomial.est_vals_dist(x, 0.7, 20)
print("b) P(X < 10) =", redondear(binomial.prob(x < 10), 4))

print("")
print("5.9")
binomial.est_vals_dist(x, 0.25, 15)
...
print("")
print("5.11")
binomial.est_vals_dist(x, 0.9, 7)
print("P(X = 5) =", redondear(binomial.prob(Eq(x, 5)), 4))

print("")
print("5.13")
binomial.est_vals_dist(x, 0.7, 5)
print("P(X >= 3) =", redondear(binomial.prob(x >= 3), 4))

print("")
print("5.15")
binomial.est_vals_dist(x, 0.4, 5)
...
print("")
print("5.25")
binomial.est_vals_dist(x, 0.1, 20)
print("P(X <= 3) =", redondear(binomial.prob(x <= 3), 4))

print("")
print("5.27")
binomial.est_vals_dist(x, 0.9, 20)
